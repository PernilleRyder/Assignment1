---
title: "A1_P1_Student"
author: "Céline Carlsen + Pernille Nikolajsen"
date: "29/8/2017"
...
#Children you didn't complete all trials has less than 6 visits
  
  tally() # wraps the number of rows
...
```{r}
select =select(final_data1, Diagnosis=="ASD") #doesn't work
select_data=select(final_data1, CHI_MLU, tokens_CHI)
select_data=merge(subset_asd, select_data)
