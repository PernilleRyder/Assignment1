...
```{r}
library(readr)
lu_data = read_csv("~/Desktop/Assignment1/LU_train.csv")
demo_data = read_csv("~/Desktop/Assignment1/demo_train(1).csv")
token_data = read_csv("~/Desktop/Assignment1/token_train.csv")
```
